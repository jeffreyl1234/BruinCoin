...
export default function ProfileScreen({ onBack, onLogout, viewUserId, onTradePress, onEditListings, onSettings, refreshTrigger }: ProfileScreenProps) {
  ...
  const fetchUserListings = async (targetUserId: string) => {
    try {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        {viewUserId && <View style={{ width: 28 }} />}
      </View>
